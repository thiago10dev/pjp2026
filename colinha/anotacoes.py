...
SELECT _____ , COUNT (____) FROM ____ JOIN _____ ON ______._______ = _____._____ GROUP BY ____.________ HAVING COUNT (____) > ____
...
agrupa                      GROUP BY           filtro de agrupamento                                                           SELECT i_categoria, COUNT (1) FROM livro GROUP BY id_categoria
integra                     JOIN               INTEGRA RESGISTROS NA FILTRAGEM                                                 SELECT nome_categoria, COUNT (1) FROM livro JOIN categoria ON categoria.id_categoria = livro.id_categoria GROUP BY livro.id_categoria
filtra grupos               HAVING             filtra grupos (diferente de WHERE, que filtra linhas antes do agrupamento)      SELECT nome_categoria , COUNT (1) FROM livro JOIN categoria ON categoria.id_categoria = livro.id_categoria GROUP BY livro.id_categoria HAVING COUNT (1) > 1
                            SUM
                            MAX
                            MIN
                            AVG
